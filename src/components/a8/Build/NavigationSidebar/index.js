...
const NavigationSidebar = ({
    ...
    return(
        <div className = 'list-group '>
            ...
            <Link to="/a8/twitter/notifications" className = {`list-group-item  ${active === 'notifications' ? 'active' : ''}`} >
                <i className='fas fa-bell fa-inverse'></i>
                <span className='d-none d-xl-inline text-white'>   Notifications</span>                    
            </Link>
            <Link to="/a8/twitter/messages" className = {`list-group-item  ${active === 'messages' ? 'active' : ''}`} >
                <i className='fas fa-envelope fa-inverse'></i>
                <span className='d-none d-xl-inline text-white'>   Messages</span>                    
            </Link>
            <Link to="/a8/twitter/bookmarks" className = {`list-group-item  ${active === 'bookmarks' ? 'active' : ''}`} >
                <i className='fas fa-bookmark fa-inverse'></i>
                <span className='d-none d-xl-inline text-white'>   Bookmarks</span>                    
            </Link>
            <Link to="/a8/twitter/lists" className = {`list-group-item  ${active === 'lists' ? 'active' : ''}`} >
            ...
            <Link to="/a8/twitter/more" className = {`list-group-item  ${active === 'more' ? 'active' : ''}`} >
